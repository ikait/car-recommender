...
// ブラウザの操作をリッスンするためのイベント登録
View.prototype.registEvent = function () {
  var self = this;
  ...
  jQuery(function ($) {
    ...
    // トリガー
    $($search_box, $search_cartype).on('keyup keypress change', self.showSearchResults);

  });
};

//
View.prototype.showSearchResults = function () {
