  ...
  return {
    ...
    preProcessing: function (op, callback) {
      ...
      */
      ...
      this.useRow0thToHanrei = op.config.useRow0thToHanrei || this.gcf.useRow0thToHanrei || 'none';
      if (this.type === 'scatter') {
        ...
        if (this.useRow0thToHanrei === 'yes')
          ...
          this.hanreiNames = 
            this.util.uniq(this.colNames.slice(1)); //hanrei判例リスト 修正 20130413 Thanx piyoさん
    ...
    _css_arc: function(op){
      ...
      function showTooltip(id,e){
        ...
        if(that.type==='scatter'){
          ...
          var percent = (that.percentVal === 'yes')?'<span class="-ccchart-ttip-percent"> ( ' + percent + ' ) </span>':''
          var htm = ''
